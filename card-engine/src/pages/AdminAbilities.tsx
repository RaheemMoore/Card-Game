  ...
  return (
    <div>
      <AdminPageDescription
        title="Abilities — library + moderation + art review"
        body={
          'Everything about the game\'s ability library, split into four tabs:\n\n' +
          '• Review Queue — proposed / experimental ability definitions from forge runs. Approve promotes to active, Reject drops it, Merge redirects players to an existing approved ability, Fire Leonardo generates candidate art (see the Art tab).\n' +
          '• Approved — the visual library. Click any tile to open a right-side drawer with meta, current-version mechanics, art history, and raw JSON.\n' +
          '• Art Candidates — ability art generated by Leonardo lands here as a "candidate" side-by-side with the current approved art. Approve promotes it (old art marked "replaced"), Reject deletes it. Prior approved art stays live until a candidate wins — a failed generation can\'t leave an ability without art.\n' +
          '• All — flat table of every definition regardless of status.'
        }
      />
      {analytics && (
