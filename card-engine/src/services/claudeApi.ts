...
/**
 * Style anchor — MUST open every portraitPrompt verbatim. Distilled from
 * eight of Raheem's reference favorites (2026-07-19) — the shared visual
 * language across Barbarian, Vampire, Necromancer, Seraph, and warrior
 * cards he considered exemplary.
 *
 * Key traits captured:
 * - Fantasy TCG illustration style (Magic the Gathering / Hearthstone reference)
 * - Waist-up 3/4 body composition, character occupies 55–70% of frame
 * - Character centered, entire head fully visible, no cropping
 * - Dramatic backlit rim-light halo behind the character (universal signature)
 * - Warm color glow wraps the character (orange/gold/red depending on element)
 * - Architectural OR environmental background with painterly blur
 * - Detailed face with intense eye contact, semi-realistic painterly rendering
 * - Rich saturated palette with deep blacks and glowing accents
 */
const STYLE_ANCHOR =
  'fantasy trading card game illustration in the style of Magic the Gathering and Hearthstone, painterly digital art with visible brush texture and semi-realistic rendering, waist-up 3/4 body composition, single character centered and occupying 55 to 70 percent of the frame, entire head fully visible with detailed face and intense expression, dramatic backlit rim-light halo glowing behind the character, warm color glow wrapping the character, painterly-blurred architectural or environmental background carrying narrative meaning, rich saturated palette with deep blacks and glowing accents, high detail on face hands and equipment';
