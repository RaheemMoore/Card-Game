---
name: production-log
description: Update PRODUCTION.md and republish the production guide after work lands, a decision gets made, or a question needs Raheem's ruling. Refreshes recommendations, moves status entries, opens or closes threads, appends a dated decision-log entry, and regenerates the HTML page; deployment remains a separate human gate. Use at the end of any session that shipped something, decided something, or raised something. Do NOT record unfinished work as shipped.
---
...
Do not invent new tokens — the whole reason this vocabulary exists is that AGENTS.md had
