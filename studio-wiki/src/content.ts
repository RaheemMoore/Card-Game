...
export const searchEntries = [
  ...
  { path: '/work/tori', title: "Tori's Desk", text: 'shared notebook open to both notes replies tags pinned lore assignments bosses telegraphs move names archetype voice canon review Tori' },
  { path: '/work/raheem', title: "Raheem's Desk", text: 'shared notebook open to both ideas capture remember focus notes replies tags pinned not tasks Raheem' },
];
